...
public class ResumeTestData {
    ...
    static final Resume RESUME_4 = new Resume(UUID_4,
                                              FULL_NAME_4);
    static final Resume RESUME_NOT_EXISTED = new Resume(NOT_EXISTED_UUID,
                                                        NOT_EXISTED_FULL_NAME);


    public static void main(String[] args) {
        Resume resume = new Resume("test resume fullname");

        resume.setContact(ContactType.PHONE_NUMBER,
                          "+7(921) 855-0482");
        resume.setContact(ContactType.SKYPE,
                          "skype:grigory.kislin");
        resume.setContact(ContactType.EMAIL,
                          "gkislin@yandex.ru");
        resume.setContact(ContactType.LIKEDIN_PROFILE,
                          "https://www.linkedin.com/in/gkislin");
        resume.setContact(ContactType.GITHUB_PROFILE,
                          "https://github.com/gkislin");
        resume.setContact(ContactType.STACKOVERFLOW_PROFILE,
        ...
        educationList.add(new Occupation(null,
                                         "Coursera",
